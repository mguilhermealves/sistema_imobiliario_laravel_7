                            ...
                            <div class="row mt-5">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Nome</label>
                                        <input type="text" name="name_category" id="name_category" class="form-control" value="{{ $account_category->name_category }}"
                                            autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Tipo</label>
                                        <input type="text" name="type_category" id="type_category" class="form-control" value="{{ $account_category->type_category }}"
                                            autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cost_center_category" id="center_category" value="{{ $account_category->cost_center_category }}"
