                        ...
                        <div class="tab-pane fade" id="dados_conjuge" role="tabpanel" aria-labelledby="dados_conjuge-tab">
                            <div class="row mt-5">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name_partner" id="first_name_partner"
                                            class="form-control" value="{{ $client->partner->first_name_partner }}" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_name_partner" id="last_name_partner"
                                            class="form-control" value="{{ $client->partner->last_name_partner }}" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cpf_cnpj_partner" id="cpf_cnpj_partner"
                                            class="form-control" value="{{ $client->partner->cpf_cnpj_partner }}" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>RG</label>
                                        <input type="text" name="rg_partner" id="rg_partner" class="form-control" value="{{ $client->partner->rg_partner }}"
                                            autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>CNH</label>
                                        <input type="text" name="cnh_partner" id="cnh_partner" class="form-control" value="{{ $client->partner->cnh_partner }}"
                                            autofocus>
                                    </div>
                                </div>
                                ...
                                @if (!empty($client->partner->file))
                                    <div class="col-sm-4">
                                        <label>Certidão de Casamento</label>
                                        <div class="form-group">
                                            <iframe class="pdf" src="{{ url("storage/{$client->partner->file->url}") }}" width="100%" height="200px"></iframe>
                                            <a href="{{ url("storage/{$client->partner->file->url}") }}" download>Download</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
